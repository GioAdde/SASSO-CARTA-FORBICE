...
class Program
{
	static void Main(string[] args)
	{
		...
		Giocatore g1 = new Giocatore(Console.ReadLine()); // creo un oggetto di tipo Giocatore con nome Mario
		 Console.WriteLine("Inserisci il nome del tuo avversario");
        Giocatore g2 = new Giocatore(Console.ReadLine()); // creo un oggetto di tipo Giocatore con nome Computer
